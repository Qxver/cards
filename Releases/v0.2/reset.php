<?php
session_start();
if(empty($_GET['id-email']) || empty($_GET['id-recovery'])){
...
<html>
    ...
    <body>
        ...
        <div class="login">
            <h1>New password</h1>
            <form method="POST" action="includes/inc/recovery.inc.php?<?php print "id-email={$_GET['id-email']}&id-recovery={$_GET['id-recovery']}";?>">
